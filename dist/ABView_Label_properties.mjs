...
//
function FNViewLabelProperties(_ref) {
  var AB = _ref.AB,
    ABViewPropertiesPlugin = _ref.ABViewPropertiesPlugin;
  return /*#__PURE__*/function (_ABViewPropertiesPlug) {
    function ABViewLabelProperties() {
      var _this;
      _classCallCheck(this, ABViewLabelProperties);
      _this = _callSuper(this, ABViewLabelProperties, [ABViewLabelProperties.getPluginKey(), {
        text: "",
        format: "",
        alignment: ""
      }]);
    ...
    _inherits(ABViewLabelProperties, _ABViewPropertiesPlug);
    return _createClass(ABViewLabelProperties, [{
      key: "defaultValues",
      ...
      key: "init",
      value: function () {
        var _init = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(AB) {
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                this.AB = AB;
                _context.n = 1;
                return _superPropGet(ABViewLabelProperties, "init", this, 3)([AB]);
              case 1:
                return _context.a(2);
            }
          }, _callee, this);
      ...
      key: "populate",
      value: function populate(view) {
        _superPropGet(ABViewLabelProperties, "populate", this, 3)([view]);
        var ids = this.ids;
      ...
      value: function values() {
        var values = _superPropGet(ABViewLabelProperties, "values", this, 3)([]);
        var ids = this.ids;
        var $component = $$(ids.component);
      ...
      value: function fromValues(values) {
        _superPropGet(ABViewLabelProperties, "fromValues", this, 3)([values]);
      ...
      key: "ViewClass",
      value: function ViewClass() {
        return _superPropGet(ABViewLabelProperties, "_ViewClass", this, 3)(["label"]);
      }
    }], [{
      key: "getPluginKey",
...
/***/ "./properties/FNViewLabelEditor.js"
/*!*****************************************!*\
  !*** ./properties/FNViewLabelEditor.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
//
function FNViewLabelEditor(_ref) {
  var AB = _ref.AB,
    ABViewEditorPlugin = _ref.ABViewEditorPlugin;
  return /*#__PURE__*/function (_ABViewEditorPlugin) {
    function ABViewLabelEditor(view) {
      var base = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "interface_editor_viewlabel";
      var ids = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      _classCallCheck(this, ABViewLabelEditor);
      ...
      return _callSuper(this, ABViewLabelEditor, [view, base, ids]);
    }
     ...
     */
    _inherits(ABViewLabelEditor, _ABViewEditorPlugin);
    return _createClass(ABViewLabelEditor, [{
      key: "ui",
      value:
      /**
       * @method ui()
      ...
      function ui() {
        ...
        return _superPropGet(ABViewLabelEditor, "ui", this, 3)([]);
      }
        ...
        var _init = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(AB) {
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _superPropGet(ABViewLabelEditor, "init", this, 3)([AB]);
              case 1:
                return _context.a(2);
            }
          }, _callee, this);
      ...
      value: function onShow() {
        _superPropGet(ABViewLabelEditor, "onShow", this, 3)([]);
        //
      ...
      value: function onHide() {
        _superPropGet(ABViewLabelEditor, "onHide", this, 3)([]);
      ...
      value: function detatch() {
        _superPropGet(ABViewLabelEditor, "detatch", this, 3)([]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ registerProperties)
/* harmony export */ });
/* harmony import */ var _properties_FNViewLabel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./properties/FNViewLabel.js */ "./properties/FNViewLabel.js");
/* harmony import */ var _properties_FNViewLabelEditor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./properties/FNViewLabelEditor.js */ "./properties/FNViewLabelEditor.js");


function registerProperties(PluginAPI) {
  return [(0,_properties_FNViewLabel_js__WEBPACK_IMPORTED_MODULE_0__["default"])(PluginAPI), (0,_properties_FNViewLabelEditor_js__WEBPACK_IMPORTED_MODULE_1__["default"])(PluginAPI)];
}
})();
...
//# sourceMappingURL=ABLabel_properties.mjs.map